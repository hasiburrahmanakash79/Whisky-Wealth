      ...
      <div className="p-6 rounded-lg shadow-sm bg-[#F2F5EF] border border-[#DBDADA]">
        <div className="flex items-center justify-center gap-7">
          <div className="text-center">
            ...
            <p className="text-3xl font-bold mt-1 text-[#B8860B]">
              {data.users.totalUsers}
            </p>
            {/* <p className="text-xs mt-1 opacity-70 text-[#22C55E]">
              +12% from last month
            </p> */}
          </div>
      ...
      <div className="p-6 rounded-lg shadow-sm bg-[#ECF1EA] border border-[#DBDADA]">
        <div className="flex items-center justify-center gap-7">
          <div className="text-center">
            ...
            {/* <p className="text-xs mt-1 opacity-70 text-[#B8700B]">
              {data.offers.expiredOffers} expiring this month
            </p> */}
          </div>
